...
[data,Sigma_hat,c,first_observation,Sigma_u_sd,theta,prior_information] = snk_alhe2_load_data_set(data_set_identifier,output_gap_identifier);
...
[log_prior,log_likelihood,log_posterior,solution,A,B,C] = snk_alhe2_log_posterior_calculate(number_endogenous_variables,number_jumper_variables,number_exogenous_variables,number_observed_variables,number_state_variables,number_plms,data,theta,prior_information,Sigma_u_sd,first_observation);

%% Run Metropolis-Hastings algorithm
[theta_post_burn,log_prior_post_burn,log_likelihood_post_burn,log_posterior_post_burn,acceptance_rate] = snk_alhe2_random_walk_metropolis_hastings_algorithm(theta,Sigma_hat,c,number_draws,number_endogenous_variables,number_jumper_variables,data,number_exogenous_variables,number_observed_variables,prior_information,Sigma_u_sd,burn_proportion,number_state_variables,number_plms,first_observation);
...
figure(1)
snk_alhe2_posterior_distributions(theta_post_burn);

%% Create trace plots
figure(2)
snk_alhe2_trace_plots(theta_post_burn,log_posterior_post_burn);
