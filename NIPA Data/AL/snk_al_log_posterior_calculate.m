function [log_prior,log_likelihood,log_posterior,solution,A,B,C] = snk_al_log_posterior_calculate(number_endogenous_variables,number_jumper_variables,number_exogenous_variables,number_observed_variables,number_state_variables,number_plms,data,theta,prior_information,Sigma_u_sd,first_observation)
...
if solution == 1 && hee_test == 2
    ...
    [J_1,J_c,J_2,Psi_L_0,Psi_L_1,Psi_L_2] = snk_al_build_state_space_matrices(number_endogenous_variables,number_exogenous_variables,number_observed_variables,theta,A(:,:,1),B(:,:,1),C(:,:,1));
    ...
    for index_1 = first_observation:T
        ...
        [J_1,J_c,J_2,Psi_L_0,Psi_L_1,Psi_L_2] = snk_al_build_state_space_matrices(number_endogenous_variables,number_exogenous_variables,number_observed_variables,theta,A(:,:,index_1),B(:,:,index_1),C(:,:,index_1));
    end
