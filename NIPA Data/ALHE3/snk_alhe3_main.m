...
[data,Sigma_hat,c,first_observation,Sigma_u_sd,theta,prior_information] = snk_alhe3_load_data_set(data_set_identifier,output_gap_identifier);
...
[log_prior,log_likelihood,log_posterior,solution,A,B,C] = snk_alhe3_log_posterior_calculate(number_endogenous_variables,number_jumper_variables,number_exogenous_variables,number_observed_variables,number_state_variables,number_plms,data,theta,prior_information,Sigma_u_sd,first_observation);
