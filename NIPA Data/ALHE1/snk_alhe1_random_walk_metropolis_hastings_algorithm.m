...
[log_prior,log_likelihood,log_posterior] = snk_alhe1_log_posterior_calculate(number_endogenous_variables,number_jumper_variables,number_exogenous_variables,number_observed_variables,number_state_variables,number_plms,data,theta,prior_information,Sigma_u_sd,first_observation);
...
for mh_draws_index = 2:number_draws
    ...
    [log_prior,log_likelihood,log_posterior] = snk_alhe1_log_posterior_calculate(number_endogenous_variables,number_jumper_variables,number_exogenous_variables,number_observed_variables,number_state_variables,number_plms,data,mh_theta_candidate(mh_draws_index,:)',prior_information,Sigma_u_sd,first_observation);
