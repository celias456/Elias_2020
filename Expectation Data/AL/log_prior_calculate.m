function [log_prior] = log_prior_calculate(parameters,prior_information)
%Calculates the log prior of a vector of parameters with given prior
%information
...
log_prior = sum(log_prior_individual_values);