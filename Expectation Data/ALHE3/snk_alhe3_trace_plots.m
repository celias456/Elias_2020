function [] = snk_alhe3_trace_plots(theta,log_posterior)
...
title('Draws of $gn_B$','interpreter','latex')
subplot(4,4,14), plot(x,theta(:,13));%Plot of draws of gn_C
title('Draws of $gn_C$','interpreter','latex')
subplot(4,4,15), plot(x,theta(:,14));%Plot of draws of alpha_A
title('Draws of $\alpha_A$','interpreter','latex')
subplot(4,4,16), plot(x,theta(:,15));%Plot of draws of alpha_B
title('Draws of $\alpha_B$','interpreter','latex')
end
