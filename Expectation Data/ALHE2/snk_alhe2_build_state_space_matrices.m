function [J_1,J_c,J_2,Psi_L_0,Psi_L_1,Psi_L_2] = snk_alhe2_build_state_space_matrices(number_endogenous_variables,number_jumper_variables_agent_type,number_exogenous_variables,number_observed_variables,theta,A,B,C)
...
eq_m_1 = 1;  %Expected output gap
eq_m_2 = 2;  %Expected inflation
...
%Equation 3
H_1(eq_s_3,i) = 1;
H_1(eq_s_3,E_A_x) = -i_x*alpha_A;
H_1(eq_s_3,E_B_x) = -i_x*alpha_B;
H_1(eq_s_3,E_C_x) = -i_x*(1-alpha_A-alpha_B);
H_1(eq_s_3,E_A_pi) = -i_pi*alpha_A;
H_1(eq_s_3,E_B_pi) = -i_pi*alpha_B;
H_1(eq_s_3,E_C_pi) = -i_pi*(1-alpha_A-alpha_B);
...
%Equation 1
Psi_L_2(eq_m_1,E_A_x) = alpha_A;
Psi_L_2(eq_m_1,E_B_x) = alpha_B;
Psi_L_2(eq_m_1,E_C_x) = (1-alpha_A-alpha_B);

%Equation 2
Psi_L_2(eq_m_2,E_A_pi) = alpha_A;
Psi_L_2(eq_m_2,E_B_pi) = alpha_B;
Psi_L_2(eq_m_2,E_C_pi) = (1-alpha_A-alpha_B);
