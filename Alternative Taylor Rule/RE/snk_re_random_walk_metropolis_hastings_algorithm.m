function [theta_post_burn,log_prior_post_burn,log_likelihood_post_burn,log_posterior_post_burn,acceptance_rate] = snk_re_random_walk_metropolis_hastings_algorithm(theta,Sigma_hat,c,number_draws,number_endogenous_variables,number_jumper_variables,data,number_exogenous_variables,number_observed_variables,prior_information,Sigma_u_sd,burn_proportion,first_observation)
%Conducts the Metropolis-Hastings random walk algorithm for the simple
...
[log_prior,log_likelihood,log_posterior,~,~,~,~] = snk_re_log_posterior_calculate(number_endogenous_variables,number_jumper_variables,number_exogenous_variables,number_observed_variables,data,theta,prior_information,Sigma_u_sd,first_observation);
...
for mh_draws_index = 2:number_draws
    ...
    [log_prior,log_likelihood,log_posterior] = snk_re_log_posterior_calculate(number_endogenous_variables,number_jumper_variables,number_exogenous_variables,number_observed_variables,data,mh_theta_candidate(mh_draws_index,:)',prior_information,Sigma_u_sd,first_observation);
