function [] = snk_alhe3_posterior_distributions(theta)
%Plots the posterior distributions for the simple New Keynesian model
%with adaptive learning and heterogeneous expectations (ALHE3)
...
subplot(4,4,8), hist(theta(:,8));%Histogram of the posterior dist. of r_pi
title('Posterior of $i_pi$','interpreter','latex')
...
subplot(4,4,13), hist(theta(:,13));%Histogram of the posterior dist. of gn_C
title('Posterior of $gn_C$','interpreter','latex')
subplot(4,4,14), hist(theta(:,14));%Histogram of the posterior dist. of alpha_A
title('Posterior of $\alpha_A$','interpreter','latex')
subplot(4,4,15), hist(theta(:,15));%Histogram of the posterior dist. of alpha_B
title('Posterior of $\alpha_B$','interpreter','latex')
end
