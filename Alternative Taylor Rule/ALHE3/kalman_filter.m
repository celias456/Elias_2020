...
%  - s_bar_initial: n*1 vector of initial values of the state variables
%  - P_initial: n*n covariance matrix of initial values of the state
%    variables
...
%F_t_given_tm1_inv = pinv(F_t_given_tm1); %Use the p-inverse

%Get the inverse of F
if F_t_given_tm1_determinant == 0
   F_t_given_tm1_inv = pinv(F_t_given_tm1); %Matrix is singular; use the p-inverse
else
   F_t_given_tm1_inv = F_t_given_tm1^(-1); %Matrix is invertible
end
