function [A,R_A_x,R_A_pi,z_A,B,R_B_x,R_B_pi,z_B,C,R_C_x,R_C_pi,z_C,state_variables] = snk_alhe3_initialize_learning(number_state_variables,number_plms,hee,T)
