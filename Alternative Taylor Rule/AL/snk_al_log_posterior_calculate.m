...
if solution == 1 && hee_test == 2
    ...
    [A,R_A_x,R_A_pi,z_A,B,R_B_x,R_B_pi,z_B,C,R_C_x,R_C_pi,z_C,~] = snk_al_initialize_learning(number_state_variables,number_plms,hee,T);
    ...
    [J_1,J_c,J_2,Psi_L_0,Psi_L_1,Psi_L_2] = snk_al_build_state_space_matrices(number_endogenous_variables,number_jumper_variables_agent_type,number_exogenous_variables,number_observed_variables,theta,A(:,:,1),B(:,:,1),C(:,:,1));
    ...
    for index_1 = first_observation:T
        ...
        [J_1,J_c,J_2,Psi_L_0,Psi_L_1,Psi_L_2] = snk_al_build_state_space_matrices(number_endogenous_variables,number_jumper_variables_agent_type,number_exogenous_variables,number_observed_variables,theta,A(:,:,index_1),B(:,:,index_1),C(:,:,index_1));
    end
